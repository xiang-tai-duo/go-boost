...
type (
	...
	PUBLISH_CALLBACK      func(client *server.Client, packet packets.Packet)
	SUBSCRIBE_CALLBACK    func(client *server.Client, packet packets.Packet)
	SUBSCRIBED_CALLBACK   func(client *server.Client, packet packets.Packet)
	UNSUBSCRIBE_CALLBACK  func(client *server.Client, packet packets.Packet)
	UNSUBSCRIBED_CALLBACK func(client *server.Client, packet packets.Packet)
	CONNECT_CALLBACK      func(client *server.Client, packet packets.Packet)
	DISCONNECT_CALLBACK   func(client *server.Client, err error)
	AUTH_CALLBACK         func(client *server.Client, packet packets.Packet) bool
	ACL_CHECK_CALLBACK    func(client *server.Client, topic string, write bool) bool
	...
	MQTT_SERVER struct {
		...
		subscribedCallback   SUBSCRIBED_CALLBACK
		unsubscribeCallback  UNSUBSCRIBE_CALLBACK
		unsubscribedCallback UNSUBSCRIBED_CALLBACK
		connectCallback      CONNECT_CALLBACK
		disconnectCallback   DISCONNECT_CALLBACK
		authCallback         AUTH_CALLBACK
		aclCheckCallback     ACL_CHECK_CALLBACK
	}
