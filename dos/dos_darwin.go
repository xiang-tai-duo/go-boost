// Package dos
// File:        dos_darwin.go
// Url:         https://github.com/xiang-tai-duo/go-boost/blob/master/dos/dos_darwin.go
// Author:      TRAE.AI
...
const (
	...
	ACTION_RUNAS           = "runas"
	MODE_DIR               = 0755
	MODULE_NAME_DOS_DARWIN = "dos_darwin"
)

//goland:noinspection GoUnusedFunction
func __debug(message string) {
	logger.Logger.DebugEx(message, MODULE_NAME_DOS_DARWIN, logger.SKIP_STACK_FRAMES_BASE)
}

//goland:noinspection GoUnusedFunction
func __info(message string) {
	logger.Logger.InfoEx(message, MODULE_NAME_DOS_DARWIN, logger.SKIP_STACK_FRAMES_BASE)
}

//goland:noinspection GoUnusedFunction
func __warning(message string) {
	logger.Logger.WarningEx(message, MODULE_NAME_DOS_DARWIN, logger.SKIP_STACK_FRAMES_BASE)
}
...
func __error(message interface{}) {
	logger.Logger.ErrorEx(message, MODULE_NAME_DOS_DARWIN, logger.SKIP_STACK_FRAMES_BASE)
}
