...
// Url:         https://github.com/xiang-tai-duo/go-boost/blob/master/electron/electron_windows.go
// Author:      TRAE.AI
...
const (
	...
	ELECTRON_DISTRIBUTION_PATH  = "dist/win-unpacked"
	ELECTRON_NO_SANDBOX         = ""
	MODULE_NAME_ELECTRON_WINDOWS = "electron_windows"
)
