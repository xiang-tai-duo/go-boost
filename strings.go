...
// NewString creates a new STRING instance with the given value
func NewString(value string) *STRING {
	return &STRING{value: value}
}

// Equals checks if the string is equal to the given string
func (s *STRING) Equals(t string) bool {
	return s.Compare(t) == 0
}

// EqualsIgnoreCase checks if the string is equal to the given string, ignoring case
