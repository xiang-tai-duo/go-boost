...
go mod tidy
go build -ldflags="-extldflags=-static" -o "%OUTPUT_32_EXE%"
go build -ldflags="-extldflags=-static" -buildmode=c-shared -o "%OUTPUT_32_DLL%"
...
go mod tidy
go build -ldflags="-extldflags=-static" -o "%OUTPUT_64_EXE%"
go build -ldflags="-extldflags=-static" -buildmode=c-shared -o "%OUTPUT_64_DLL%"
