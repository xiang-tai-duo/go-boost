// Package boost
// File:        mqtt.go
// Url:         https://github.com/xiang-tai-duo/go-boost/blob/master/mqtt.go
// Author:      Vibe Coding
...
func (m *MQTT) Connect() error {
	...
	if m.client != nil && m.client.IsConnected() {
		...
		opts.SetConnectionLostHandler(func(client paho.Client, reason error) {
			m.lock.Lock()
			m.connected = false
			m.lock.Unlock()
		})
...
func (m *MQTT) internalMessageHandler(client paho.Client, msg paho.Message) {
